document.addEventListener('DOMContentLoaded', () => {
    const characterData = [
        { 
            name: 'Dinesh', 
            role: 'Aspiring Developer & Gamer', 
            age: '19 years old', 
            location: 'Guntur,Andhra Pradesh-INDIA', 
            quote: '“Code is like humor. When you have to explain it, it’s bad.”', 
            bio: 'Passionate about technology and the creative process of building websites, I enjoy turning ideas into digital spaces that are simple, functional, and lasting. Outside of work, movies are a big part of my life—not just for entertainment but as a way to connect, reflect, and stay inspired. As a follower of Pawan Kalyan, I admire the values he represents—discipline, resilience, and standing up for what matters—and I try to bring the same energy into my own journey. Balancing professional goals with personal interests, I believe in steady growth, meaningful contributions, and finding inspiration in both code and cinema.', 
            hobbies: ['📺 TFI', '📚 AI', '🎧 Music'], 
            images: [
                'images/Dinesh.jpg', 
                'images/Dinesh_2.jpg', 
                'images/Dinesh_3.jpg', 
                'images/Dinesh_4.jpg', 
                { type: 'video', src: 'videos/dinesh_clip.mp4' }
            ], 
            color: '#ff6347' 
        },
        { 
            name: 'Snehith', 
            role: 'Creative Thinker & Club Owner', 
            age: '19 years old', 
            location: 'India', 
            quote: '“Creativity is intelligence having fun.”', 
            bio: 'Owner of the Horror Language Brainrot Club, known for bringing wild and unique perspectives into everything. Always looking for the strange, the unexpected, and the fun in conversations. Balances humor and creativity with an offbeat style that makes him stand out. At just 21, already shaping spaces where creativity and chaos collide.', 
            hobbies: ['🚽 Skibidy Toilet', '🗣️🔥 DHABIDI-DHIBIDI'], 
            images: [
                'images/Snehith.jpg', 
                'images/Snehith_2.jpg', 
                'images/Snehith_3.jpg', 
                'images/Snehith_4.jpg', 
                { type: 'video', src: 'videos/snehith_clip.mp4' }
            ], 
            color: '#4682b4' 
        },
        { 
            name: 'Cris Samuel', 
            role: 'AM to PM in girls DM', 
            age: '19', 
            location: 'India', 
            quote: '“Women are like fine wine—the older they get, the rarer the taste.”', 
            bio: 'Women aren’t meant to be chased like prizes; they’re meant to be appreciated like masterpieces. True beauty doesn’t fade with age—it matures, sharpens, and deepens, just like fine wine. Confidence and grace are worth more than any fleeting trend. The real game isn’t in collecting attention, it’s in earning respect. A king doesn’t conquer women; he understands them, learns from them, and values the elegance that time only enhances. Life isn’t about running after validation—it’s about moving with presence, savoring conversations like vintage bottles, and recognizing that rarity is built, not given.', 
            hobbies: ['👧 Ammai Settu', '❤️Heartu'], 
            images: [
                'images/cris_samuel.jpg', 
                'images/cris_samuel_2.jpg', 
                'images/cris_samuel_3.jpg', 
                'images/cris_samuel_4.jpg', 
                { type: 'video', src: 'videos/cris_clip.mp4' }
            ], 
            color: '#3cb371' 
        },
        { 
            name: 'Karthikeya', 
            role: 'Bullet Enthusiast', 
            age: '19 years old', 
            location: 'India', 
            quote: '“Life’s better with the engine roaring.”', 
            bio: 'Life feels alive on the Bullet—the loud engine, the open road, and the unmatched vibe. Known for staying chill, hanging out, and never letting things get too heavy. Plays it off like there’s no relationship in sight, but everyone knows the story without him saying a word. Loyal, fun, and always up for a ride or a laugh, he keeps the mood light while still making his presence felt.', 
            hobbies: ['🏍️ Bullet Vibes', '🎥 Reels', '🎶 Music'], 
            images: [
                'images/Karthikeya.jpg', 
                'images/Karthikeya_2.jpg', 
                'images/Karthikeya_3.jpg', 
                'images/Karthikeya_4.jpg', 
                { type: 'video', src: 'videos/karthikeya_clip.mp4' }
            ], 
            color: '#98fb98' 
        },
        { 
            ...
            images: [
                ...
                'images/Mohan_3.jpg', 
                'images/Mohan_4.jpg', 
                { type: 'video', src: 'videos/mohan_clip.mp4' }
            ], 
            color: '#f0e68c' 
        },
        { 
            ...
            images: [
                'images/Amarnadh.jpg', 
                'images/Amarnadh_2.jpg', 
                'images/Amarnadh_3.jpg', 
                'images/Amarnadh_4.jpg', 
                { type: 'video', src: 'videos/amarnadh_clip.mp4' }
            ], 
            color: '#ba55d3' 
        },
        { 
            ...
            hobbies: ['Placeholder'], 
            images: [
                'images/venkat_sai.jpg', 
                'images/venkat_sai_2.jpg', 
                'images/venkat_sai_3.jpg', 
                'images/venkat_sai_4.jpg', 
                { type: 'video', src: 'videos/venkat_clip.mp4' }
            ], 
            color: '#ffa500' 
        },
        { 
            ...
            hobbies: ['Placeholder'], 
            images: [
                'images/Sudhanshu.jpg', 
                'images/Sudhanshu_2.jpg', 
                'images/Sudhanshu_3.jpg', 
                'images/Sudhanshu_4.jpg', 
                { type: 'video', src: 'videos/sudhanshu_clip.mp4' }
            ], 
            color: '#87ceeb' 
        },
        { 
            ...
            hobbies: ['Placeholder'], 
            images: [
                'images/deva_prasad.jpg', 
                'images/deva_prasad_2.jpg', 
                'images/deva_prasad_3.jpg', 
                'images/deva_prasad_4.jpg', 
                { type: 'video', src: 'videos/deva_clip.mp4' }
            ], 
            color: '#da70d6' 
        },
        { 
            ...
            hobbies: ['Placeholder'], 
            images: [
                'images/Chinnababu.jpg', 
                'images/Chinnababu_2.jpg', 
                'images/Chinnababu_3.jpg', 
                'images/Chinnababu_4.jpg', 
                { type: 'video', src: 'videos/chinna_clip.mp4' }
            ], 
            color: '#ffb6c1' 
        }
    ];
    ...
    function showItem(item) {
        if (typeof item === 'string') {
            ...
            detailVideo.removeAttribute('controls'); // no controls
            detailVideo.muted = false;   // unmuted
            detailVideo.volume = 1.0;    // full volume
            detailVideo.loop = true;     // loop forever
            detailVideo.autoplay = true; // autoplay
            detailVideo.play();
        }
    }
    ...
    preloadAllAssets(); // Aggressive preload
    preloadImages();    // Existing preloader flow
});
